...
namespace Knedlex.Roblox.Thumbnails.ApiV1.Api
{
    ...
    public partial class OutfitsApi : IOutfitsApi
    {
        ...
        /// <returns></returns>
        public OutfitsApi(Knedlex.Roblox.Thumbnails.ApiV1.Client.Configuration configuration)
        {
        ...
        public OutfitsApi(Knedlex.Roblox.Thumbnails.ApiV1.Client.ISynchronousClient client, Knedlex.Roblox.Thumbnails.ApiV1.Client.IAsynchronousClient asyncClient, Knedlex.Roblox.Thumbnails.ApiV1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = V1UsersOutfit3dGetWithHttpInfo(outfitId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RobloxWebResponsesThumbnailsThumbnailResponse</returns>
        public Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> V1UsersOutfit3dGetWithHttpInfo(long outfitId, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.QueryParameters.Add(Knedlex.Roblox.Thumbnails.ApiV1.Client.ClientUtils.ParameterToMultiMap("", "outfitId", outfitId));
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = await V1UsersOutfit3dGetWithHttpInfoAsync(outfitId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = V1UsersOutfitsGetWithHttpInfo(userOutfitIds, size, format, isCircular);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse</returns>
        public Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> V1UsersOutfitsGetWithHttpInfo(List<long> userOutfitIds, string size = default(string), string format = default(string), bool? isCircular = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'userOutfitIds' is set
            if (userOutfitIds == null)
            {
                throw new Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiException(400, "Missing required parameter 'userOutfitIds' when calling OutfitsApi->V1UsersOutfitsGet");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(Knedlex.Roblox.Thumbnails.ApiV1.Client.ClientUtils.ParameterToMultiMap("csv", "userOutfitIds", userOutfitIds));
            if (size != null)
            {
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = await V1UsersOutfitsGetWithHttpInfoAsync(userOutfitIds, size, format, isCircular, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
