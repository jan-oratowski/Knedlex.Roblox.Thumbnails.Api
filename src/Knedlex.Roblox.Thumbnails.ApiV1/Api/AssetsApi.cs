...
namespace Knedlex.Roblox.Thumbnails.ApiV1.Api
{
    ...
    public partial class AssetsApi : IAssetsApi
    {
        ...
        /// <returns></returns>
        public AssetsApi(Knedlex.Roblox.Thumbnails.ApiV1.Client.Configuration configuration)
        {
        ...
        public AssetsApi(Knedlex.Roblox.Thumbnails.ApiV1.Client.ISynchronousClient client, Knedlex.Roblox.Thumbnails.ApiV1.Client.IAsynchronousClient asyncClient, Knedlex.Roblox.Thumbnails.ApiV1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = V1AssetThumbnailAnimatedGetWithHttpInfo(assetId, robloxPlaceId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RobloxWebResponsesThumbnailsThumbnailResponse</returns>
        public Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> V1AssetThumbnailAnimatedGetWithHttpInfo(long assetId, long? robloxPlaceId = default(long?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.QueryParameters.Add(Knedlex.Roblox.Thumbnails.ApiV1.Client.ClientUtils.ParameterToMultiMap("", "assetId", assetId));
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = await V1AssetThumbnailAnimatedGetWithHttpInfoAsync(assetId, robloxPlaceId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RobloxWebResponsesThumbnailsThumbnailResponse)</returns>
        public async System.Threading.Tasks.Task<Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse>> V1AssetThumbnailAnimatedGetWithHttpInfoAsync(long assetId, long? robloxPlaceId = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = V1AssetsGetWithHttpInfo(assetIds, robloxPlaceId, returnPolicy, size, format, isCircular);
            return localVarResponse.Data;
        }
        ...
        public Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> V1AssetsGetWithHttpInfo(List<long> assetIds, long? robloxPlaceId = default(long?), string returnPolicy = default(string), string size = default(string), string format = default(string), bool? isCircular = default(bool?), int operationIndex = 0)
        {
            ...
            if (assetIds == null)
            {
                throw new Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiException(400, "Missing required parameter 'assetIds' when calling AssetsApi->V1AssetsGet");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(Knedlex.Roblox.Thumbnails.ApiV1.Client.ClientUtils.ParameterToMultiMap("csv", "assetIds", assetIds));
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = await V1AssetsGetWithHttpInfoAsync(assetIds, robloxPlaceId, returnPolicy, size, format, isCircular, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = V1AssetsThumbnail3dGetWithHttpInfo(assetId, robloxPlaceId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RobloxWebResponsesThumbnailsThumbnailResponse</returns>
        public Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> V1AssetsThumbnail3dGetWithHttpInfo(long assetId, long? robloxPlaceId = default(long?), int operationIndex = 0)
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.RequestOptions localVarRequestOptions = new Knedlex.Roblox.Thumbnails.ApiV1.Client.RequestOptions();
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = await V1AssetsThumbnail3dGetWithHttpInfoAsync(assetId, robloxPlaceId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RobloxWebResponsesThumbnailsThumbnailResponse)</returns>
        public async System.Threading.Tasks.Task<Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebResponsesThumbnailsThumbnailResponse>> V1AssetsThumbnail3dGetWithHttpInfoAsync(long assetId, long? robloxPlaceId = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
