...
namespace Knedlex.Roblox.Thumbnails.ApiV1.Api
{
    ...
    public partial class DeveloperProductsApi : IDeveloperProductsApi
    {
        ...
        /// <returns></returns>
        public DeveloperProductsApi(Knedlex.Roblox.Thumbnails.ApiV1.Client.Configuration configuration)
        {
        ...
        public DeveloperProductsApi(Knedlex.Roblox.Thumbnails.ApiV1.Client.ISynchronousClient client, Knedlex.Roblox.Thumbnails.ApiV1.Client.IAsynchronousClient asyncClient, Knedlex.Roblox.Thumbnails.ApiV1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = V1DeveloperProductsIconsGetWithHttpInfo(developerProductIds, size, format, isCircular);
        ...
        public Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> V1DeveloperProductsIconsGetWithHttpInfo(List<long> developerProductIds, string size = default(string), string format = default(string), bool? isCircular = default(bool?), int operationIndex = 0)
        {
            ...
            {
                throw new Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiException(400, "Missing required parameter 'developerProductIds' when calling DeveloperProductsApi->V1DeveloperProductsIconsGet");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(Knedlex.Roblox.Thumbnails.ApiV1.Client.ClientUtils.ParameterToMultiMap("csv", "developerProductIds", developerProductIds));
            if (size != null)
            {
        ...
        {
            Knedlex.Roblox.Thumbnails.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = await V1DeveloperProductsIconsGetWithHttpInfoAsync(developerProductIds, size, format, isCircular, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
